...
(function($) {
  ...
  $.ajaxPager = {
    ...
    _buildPagerBar: function(settings){
      var ui = '<div class="navbar navbar' + ((settings.inverse) ? '-inverse' : '') + ' ajaxPager' + ((settings.classes.length > 0) ? (' ' + settings.classes) : '') + '">'
          + '<div class="navbar-inner">'
            + '<div class="container">'
              ...
              + '<div class="nav-collapse collapse navbar' + ((settings.inverse) ? '-inverse' : '') + '-collapse">'
                + '<ul class="nav">'
                  + '<li><a href="#first" rel="first" class="paging-nav"><i class="icon-fast-backward' + ((settings.inverse) ? ' icon-white' : '') + '"></i></a></li>'
                  + '<li class="divider-vertical"></li>'
                  + '<li><a href="#previous" rel="previous" class="paging-nav"><i class="icon-backward' + ((settings.inverse) ? ' icon-white' : '') + '"></i></a></li>'
                  + '<li class="divider-vertical"></li>'
                + '</ul>'
                ...
                + '<ul class="nav">'
                  + '<li class="divider-vertical"></li>'
                  + '<li><a href="#next" rel="next" class="paging-nav"><i class="icon-forward' + ((settings.inverse) ? ' icon-white' : '') + '"></i></a></li>'
                  + '<li class="divider-vertical"></li>'
                  + '<li><a href="#last" rel="last" class="paging-nav"><i class="icon-fast-forward' + ((settings.inverse) ? ' icon-white' : '') + '"></i></a></li>'
                  + '<li class="divider-vertical"></li>';
      if (settings.limitdd) {
